...
class BeersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create beer" do
    assert_difference('Beer.count') do
      post beers_url, params: { beer: { brewery_id: @beer.brewery_id, integer: @beer.integer, name: @beer.name } }
    end
  ...
  test "should update beer" do
    patch beer_url(@beer), params: { beer: { brewery_id: @beer.brewery_id, integer: @beer.integer, name: @beer.name } }
